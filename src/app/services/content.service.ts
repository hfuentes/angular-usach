...
<li>Regulación de la actividad electrocatalítica en la electrooxidación de alcoholes.</li></ul><br>`,
  ...
  getNoticia(id: string): Promise<any> {
  ...
  getEstudiantes(): Promise<any> {
    return this.http.get(this.api('estudiantes/public')).toPromise();
  }

  getTesis(): Promise<any> {
    return this.http.get(this.api('tesis/public')).toPromise();
  }
  ...
  getAcademicos(): Promise<any> {
    return this.http.get(this.api('academicos/public')).toPromise();
  }
  ...
  getAcademico(id: string): Promise<any> {
  ...
  getGaleria(): any {
    return this.http.get(this.api('galeria/public')).toPromise();
  }
}
